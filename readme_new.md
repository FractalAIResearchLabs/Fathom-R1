...
Given the latest findings [anthropic, proof or bluff, overthinking] that raises the question on the correctness of the intermediate steps of the long COT, its important from interpretability, reliability and saftey pov to ensure the reasoning chains are not inefficiently long. Hence, in this study, we work towards unlocking performance improvement of the reasoning models without training at very high (24k/32k) sequence length. We believe while we might still require extremely long reasoning chains for really challenging tasks, 
